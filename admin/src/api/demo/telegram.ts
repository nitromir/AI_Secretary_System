...
const defaultBots: BotInstanceData[] = [
  {
    ...
    llm_backend: 'vllm',
    llm_persona: 'gulya',
    system_prompt: 'Ты — Гуля, AI-секретарь техподдержки. Помогай клиентам решать проблемы.',
    tts_engine: 'xtts',
    tts_voice: 'gulya',
    tts_preset: 'natural',
    action_buttons: [
  ...
  },
  {
    ...
    llm_persona: 'lidia',
    system_prompt: 'Ты — Лидия, менеджер по продажам AI-секретаря. Помогай клиентам выбрать тариф.',
    tts_engine: 'xtts',
    tts_voice: 'lidia',
