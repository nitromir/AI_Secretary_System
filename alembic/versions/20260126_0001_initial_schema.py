...
def upgrade() -> None:
    ...
    op.create_table(
        'chat_messages',
        sa.Column('id', sa.String(50), primary_key=True),
        sa.Column('session_id', sa.String(50), sa.ForeignKey('chat_sessions.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('chat_session_id', sa.String(50), sa.ForeignKey('chat_sessions.id', ondelete='CASCADE'), nullable=False),
